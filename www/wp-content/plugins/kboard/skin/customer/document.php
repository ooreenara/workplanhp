<div id="kboard-customer-document">
    ...
    <div class="kboard-detail">
      ...
      <div class="detail-attr">
        ...
        <div class="detail-value">
          <?php echo $content->option->companyname?>
        </div>
      </div>
      
      <div class="detail-attr">
        <div class="detail-name">
          <?php echo __('회사홈페이지', 'kboard')?>
        </div>
        <div class="detail-value">
          <?php echo $content->option->homepage?>
        </div>
      </div>
    ...
    <div class="kboard-detail">
      <div class="detail-attr">
        <div class="detail-name">
          <?php echo __('연락처', 'kboard')?>
        </div>
        <div class="detail-value">
          <?php echo $content->option->tel?>
        </div>
      </div>
      
      <div class="detail-attr">
        <div class="detail-name">
          <?php echo __('담당자명 및 직급', 'kboard')?>
        </div>
        <div class="detail-value">
    ...
    <div class="kboard-detail">
      <div class="detail-attr">
        ...
        <div class="detail-value">
          <?php echo $content->option->usernumber?> 명
        </div>
      </div>
    </div>
