<div id="kboard-customer-editor">
    ...
    <div class="kboard-attr-row" style="display: none;">
			<label class="attr-name"><?php echo __('Secret', 'kboard')?></label>
			<div class="attr-value"><input type="hidden" name="secret" value="true"<?php if($content->secret):?> checked<?php endif?> checked></div>
		</div>
      ...
      <div class="kboard-attr-row">
        <label class="attr-name">
          <?php echo __('구분', 'kboard')?>
        </label>

        <label class="division_title">
          <input type="radio" name="kboard_option_test" value="상담문의" <?php if($content->option->test == '상담문의'):?><?php endif; ?>>상담문의
        </label>

        <label class="division_title">
          <input type="radio" name="kboard_option_test" value="방문 및 시연문의" <?php if($content->option->test == '방문 및 시연문의'):?><?php endif; ?>>방문 및 시연문의
        </label>

        <label class="division_title">
          <input type="radio" name="kboard_option_test" value="데모아이디 요청" <?php if($content->option->test == '데모아이디 요청'):?><?php endif; ?>>데모아이디 요청
        </label>

        <label class="division_title">
          <input type="radio" name="kboard_option_test" value="제휴문의" <?php if($content->option->test == '제휴문의'):?><?php endif; ?>>제휴문의
        </label>

        <label class="division_title">
          <input type="radio" name="kboard_option_test" value="기타" <?php if($content->option->test == '기타'):?><?php endif; ?>>기타
        </label>
      </div>
      ...
      <div class="kboard-attr-row">
      <label class="attr-name">
        <?php echo __('회사명', 'kboard')?>
      </label>
      <div class="attr-value">
        <input type="text" name="kboard_option_companyname" value="<?php echo $content->option->companyname?>">
      </div>
      </div>
      ...
      <div class="kboard-attr-row">
        <label class="attr-name">
          <?php echo __('회사 홈페이지', 'kboard')?>
        </label>
        <div class="attr-value">
          <input type="text" name="kboard_option_homepage" value="<?php echo $content->option->homepage?>">
        </div>
      </div>
      <div class="kboard-attr-row">
        <label class="attr-name">
          <?php echo __('Phone number', 'kboard')?>
        </label>
        <div class="attr-value">
          <input type="text" name="kboard_option_tel" value="<?php echo $content->option->tel?>">
        </div>
      </div>
      <div class="kboard-attr-row">
			<label class="attr-name"><?php echo __('담당자명 및 직급', 'kboard')?></label>
      ...
      <div class="kboard-attr-row">
        <label class="attr-name">
          <?php echo __('사용자 수', 'kboard')?>
        </label>
        <div class="attr-value">
          <input type="text" name="kboard_option_usernumber" value="<?php echo $content->option->usernumber?>">&nbsp;명
        </div>
      </div>
