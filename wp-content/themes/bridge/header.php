...
<link rel="stylesheet" href="http://<?php echo $_SERVER['HTTP_HOST']; ?>/wp-content/themes/bridge/css/animate.css">
<script src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/wp-content/themes/bridge/js/wow.min.js"></script>
<script>
 new WOW().init();
</script>
                ...
                <?php } ?>
					<div class="header_inner_left">
						...
						<div class="logo_wrapper">
                            ...
                            <div class="q_logo_me"><a href="<?php echo home_url('/'); ?>"><img class="normal" src="/wp-content/uploads/2015/07/toplogo_noshadow_black.png" alt="Logo"/></a></div>
